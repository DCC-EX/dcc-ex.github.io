...
|EX-R| in particular pulls some very cunning, but legitimate, stunts with the pre-processor to weave your automations into the code as it's compiled.
...
* |EX-R| and the DCC ACK manager use "virtual machine" techniques to implement multitasking.
