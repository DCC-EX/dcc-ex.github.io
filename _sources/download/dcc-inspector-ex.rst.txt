...
DCC Inspector-EX is a packet sniffing tool that can connect directly to the signal pins on the Command Station or to the track depending on your circuit. For information in the `Diagnostic Tools Section <../reference/tools/diagnostic-tools.html>`_
