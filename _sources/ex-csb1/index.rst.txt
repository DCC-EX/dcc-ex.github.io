...
Benefits include: 
  ...
  * Flexible Output Management (|TM| :sup:`tm` support): Dynamically assign outputs to different modes (DC/DCC/PROG/Auto-Reverse), with proper NMRA current limits
