...
- ``vpin`` = pin number of the individual pixel in the range defined by the :ref:`HAL(NeoPixel...) <exrail/exrail-command-reference:create and manage hal device objects>`.
