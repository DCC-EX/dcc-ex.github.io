...
Pin values can be changed with basic digital pin commands common to all VPINs.  In |EX-R|
...
``ONBUTTON(200)`` triggers when a pin goes HIGH. This is most useful for push buttons connected between the pin and ground. This causes a new |EX-R| task to start and switch bounce will be ignored until the task completes.
