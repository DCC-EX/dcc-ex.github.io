...
Sensor polling by |JMRI| is independent of this, and may continue if ``<S>`` commands are used.  However there is now a way of defining |JMRI| sensors from within |EX-R| - see EXRAIL Command Reference - JMRI_SENSOR.
