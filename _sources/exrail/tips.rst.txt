...
Once these are defined, you can then use EXRAIL's ONTHROW/ONCLOSE commands to intercept the throttle/|JMRI|/|EX-R| sequence changing the virtual turnout which then runs the sequence of your choice. This will normally involve throwing or closing the invisible (but real) turnout.
...
A virtual turnout may be used in any circumstance where the turnout process is handled in |EX-R| rather than the normal process, for example a solenoid turnout requiring a pin or relay to be manipulated.

Make your own EXRAIL macro or command
======================================

One of the cunning features of |EX-R| is enabling users to define macros, or what is effectively your very own |EX-R| command.
...
This technique can be used in many different ways limited only by your imagination to have |EX-R| perform many different actions and automations.
