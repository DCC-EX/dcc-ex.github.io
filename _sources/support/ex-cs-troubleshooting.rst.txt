...
#. Verify that all of the mappings are correct for your |motor shield|. For an a |Standard Motor Driver|, you should not have changed any pin settings in the config.h file
