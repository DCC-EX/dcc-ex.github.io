...
We completely re-wrote current sense and ACK detect routines to better protect your trains and make programming more accurate. There are complete diagnostics to allow you to see exactly why a particular decoder is not reading or writing, and provides settings to get it to work in most cases.
