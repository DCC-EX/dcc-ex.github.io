...
- If you simply require a unique ID, ``ALIAS(name)`` will calculate a unique number between -65535 and 65535 based on the characters in "name", which will be used in the background.
