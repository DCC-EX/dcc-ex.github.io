...
You will note that these are somewhat similar to :ref:`ex-rail/examples:example 7: running multiple inter-connected trains`, updated to suit the specifics of the RMFT layout.
