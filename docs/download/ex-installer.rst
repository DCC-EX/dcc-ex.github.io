...
.. note:: 
   ...
   If you have any difficulties with the automated installer link try these:
      ...
      .. rst-class:: dcclink
         ...
         `For Windows x64 <https://github.com/DCC-EX/EX-Installer/releases/latest/download/EX-Installer-Win64.exe>`_

      .. rst-class:: dcclink

         `For MacOS / OSX <https://github.com/DCC-EX/EX-Installer/releases/latest/download/EX-Installer-macOS>`_
