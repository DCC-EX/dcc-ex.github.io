...
\|EX-IO\| is a software based I/O expander using an Arduino
microcontroller to expand the I/O pins available for \|EX-CS\| using
both digital and analogue pins.

You can now use \|EX-I\| to download and install \|EX-IO\|.
...
If you need to obtain the source code for any reason, it is available on
GitHub here:
