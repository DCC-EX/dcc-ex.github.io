...
\|EX-TT\| is a fully integrated turntable controller, using an Arduino
microcontroller to drive a stepper controller and motor to spin the
turntable bridge.
...
[EX-Turntable Github
Repository](https://github.com/DCC-EX/EX-Turntable/releases)
\|EXTERNAL-LINK\|
:::
