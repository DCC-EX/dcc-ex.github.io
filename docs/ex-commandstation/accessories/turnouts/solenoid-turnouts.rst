...
Refer to :ref:`ex-rail/ex-rail-command-reference:turnout/point objects and control` for details on these commands, along with :ref:`ex-rail/creating-elements:adding turnouts/points` for some further information and examples.
