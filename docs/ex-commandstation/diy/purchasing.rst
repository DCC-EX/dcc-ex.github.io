...
#. a 12-16v DC :doc:`power supply </reference/hardware/power-supplies>` [1]_ for the |motor shield| |BR| We recommend `12v 5Amp Power Supply for the Track <https://www.amazon.com/LEDMO-Power-Supply-Transformers-Adapter/dp/B01461MOGQ/>`_ for Z and N Scale with the |EX-MS| |BR| |BR|
...
#. some **wire** (18 to 16 AWG twisted pair recommended [2]_.) |BR| |BR|
...
.. [2] **Wire Gauge** - The standard Arduino/Deek |Motor Driver| can only provide about 1.5 Amps of power (despite being rated for 2A), so 18 AWG wire is ample. If you use a different |Motor Driver| and deliver more current to your track, you may need thicker wire (lower number gauge).
