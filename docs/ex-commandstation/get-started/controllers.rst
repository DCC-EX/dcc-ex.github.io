...
Here is a list of some of the controllers you can use with the |EX-CS|. We work closely with developers to help them maintain compatibility with the |EX-CS|. 
