...
Once connected, you will need to configure the device driver as per :ref:`ex-commandstation/sensors/vl53l0x-tof-sensor:configuring a single device`.
...
Once connected, you will need to configure the device driver for each device as per :ref:`ex-commandstation/sensors/vl53l0x-tof-sensor:configuring multiple devices`.
