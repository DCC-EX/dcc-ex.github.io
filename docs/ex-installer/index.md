...
- You have DIY assembled your \|EX-CS\| hardware you need to load our
  software onto it make is usable.
- You purchased an \|EX-CSB1\| you wish to reload our software to enable
  additional features.

Then, to make it as simple as possible, we have created the \|EX-I\|
program.
