...
****************************************************
Automated Installer (Full Instructions)
****************************************************

|tinkerer| |engineer|

This page describes all the feature and options of the |EX-I|.  If you identify as an a |conductor-text| and have installed just the recommended hardware we suggect that you look at the instructions on the :doc:`/ex-commandstation/get-started/installer` page.
