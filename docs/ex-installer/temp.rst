...
If you have purchased an |EX-CSB1| it will have come with the |EX-CS| software already installed.  You only need to look at this page if you want to change the default configuration. 
...
.. figure:: /_static/images/ex-installer/not-commonly-downloaded-warning.png
...
.. figure:: /_static/images/ex-installer/not-commonly-downloaded-keep.png
...
.. figure:: /_static/images/ex-installer/not-commonly-downloaded-keep-anyway.png
   :alt: File not commonly downloaded - Keep Anyway
   :scale: 55%
   :align: left

* Open *Windows Explorer*
* Find the folder in which the **EX-Installer-Setup-Win64.exe** was saved. This will typically default to downloading to the *downloads* folder but your browser may be configured differently.
* **Run** ``EX-Installer-Setup-Win64.exe`` (Note the '.exe' may or may not appear)  |BR| |BR|

.. figure:: /_static/images/ex-installer/ex-installer-setup-allow-changes.png
   :alt: EX-Installer - Allow Changes
   :scale: 55%
   :align: left

   Install EX-Installer - Allow Changes
...
.. figure:: /_static/images/ex-installer/ex-installer-setup-license.png
   ...
   Install EX-Installer - Accept License Agreement
...
.. figure:: /_static/images/ex-installer/ex-installer-setup-destination.png
   ...
   Install EX-Installer - Select Destination
...
.. figure:: /_static/images/ex-installer/ex-installer-setup-start-menu.png
   ...
   Install EX-Installer - Select Start Menu Folder
...
.. figure:: /_static/images/ex-installer/ex-installer-setup-finish.png
   ...
   Install EX-Installer - Completing Setup
