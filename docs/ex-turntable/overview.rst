...
The aim is to keep things as simple as possible, and to maintain alignment with the categories of our users as defined in our :ref:`begin/levels:choose your comfort level` guide for |EX-CS| (|conductor-text|, |tinkerer-text|, and |engineer-text|).
