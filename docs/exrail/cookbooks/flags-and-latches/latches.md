...
`ONBUTTON </exrail/exrail-command-reference>`{.interpreted-text
role="doc"} event handler.
...
simpler `/exrail/cookbooks/flags-and-latches/flags`{.interpreted-text
role="doc"} feature which provides virtual VPINs that can be set, reset
