...
Introducing DCC-EX In the Know
==============================

Yep, that's right, the DCC-EX team are now publishing news regularly with our new "DCC-EX In the Know" feed!
...
If you wish to follow "DCC-EX In the Know", we will have the latest few posts published on the front page of our website, along with the `complete list here <https://dcc-ex.com/blog.html>`_.

If you use an RSS/Atom feed reader, you can add "DCC-EX In the Know" by adding our website "https://dcc-ex.com".
