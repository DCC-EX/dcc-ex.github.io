...
Our products are predominately Do-It-Yourself(DIY) and range in difficulty from simple enough for DCC beginngers, all the way through to moderately complex. Look at the descriptions of the categories below to work out your own personal comfort/skill level. (A |Conductor-text|, a |Tinkerer-text|, or an |Engineer-text|.)
...
.. list-table::
    ...
    * - .. image:: /_static/images/level_icons/tinkerer.png
           ...
           :width: 144px
           :class: image-min-width-72
      - A |Tinkerer-text| finds joy in building things themselves. |BR| |BR| They may not have an Engineering Degree, but they know how to connect a jumper wire and use a soldering iron. They don't have a problem opening something like the Arduino IDE to change settings in a configuration file and upload it to the Command Station. A Tinkerer wants to do more with model trains, like more detailed control of turnouts/points, sensors, and other accessories, or perhaps even automating their layout with |EX-R|. |BR| |BR| This path will provide more options over the Conductor path, and cover things like expanding your system and using the |JMRI| software (Java Model Railroad Interface) for more advanced control of your locomotives and your track. |BR| |BR| We also recommend that you :doc:`start here to build your EX-CommandStation <ex-commandstation/get-started/index>` if you have not already done so, but look out for the |Tinkerer-text| notes on the pages to see other options.
