...
:tags: ex-commandstation dcc-ex dcc++
:image: 0
...
* Developed a new browser based throttle (:doc:`EX-WebThrottle </ex-webthrottle/index>`)
* New "DriveAway" feature to be able to recognise a loco on a siding used as a programming track and drive off of onto the main track
...
We assembled a team of software developers and electronics engineers from around the world, created a plan, and started work early in 2020. (See the team information and credits on the :doc:`About page </about/index>`)
...
Click here for :doc:`The DCC-EX Team Credits </about/index>`
