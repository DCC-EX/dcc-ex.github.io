...
Entrepreneurs wanting to offer commercial quantities to their local communities should contact Semify (service @ semify-eda.com) to arrange a bulk purchase, or DCC-EX (support @ dcc-ex.com) when to looking to use the design to manufacture. Licensing includes donating a royalty to DCC-EX per board sold. Semify has a separate arrangement with DCC-EX due to their funding of the prototyping and work on verifying and testing the design.
