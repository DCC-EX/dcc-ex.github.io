...
This release includes the below changes, and as always we encourage you to download this latest version of :doc:`/download/ex-installer` from our downloads page:
