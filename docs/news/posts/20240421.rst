...
The **Arduino Uno and Nano**, however, are **no longer recommended** as good platforms as they are just too limited in terms of resources and capability, and will not work with some of our new features such as :doc:`/trackmanager/index` or I/O expanders. These can still be handy as dedicated programming only devices with |JMRi| or for simple Christmas layouts of course, but don't expect to be using any of our new features on these devices.
