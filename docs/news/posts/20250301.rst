...
- Supoort for `EX-SensorCam <https://dcc-ex.com/news/posts/20240215.html>`_ for low cost camera based occupancy detection
...
- New Set/Reset multiple pins at once with **SET( vpin [,count] )** and **RESET( vpin [,count])**
...
- DCC++ Traffic Monitor and Send DCC++ Command multi-connection-aware
