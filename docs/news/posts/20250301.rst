...
- Run up to 10 WiFi Throttles simultaneously (even more when using JMRI)
...
- New **XFWD** set current loco direction to forward
- New **XREV** set current loco direction to reverse
...
* Expressif ESP32-D0WD based platforms with builtin WiFi for up to 10 throttles
  * EX-CommandStation / Booster One (EX-CSB1)
  * ESPDuino32 (with modifications)
* STMicroelectronics STM32F4xx platforms, specifically the STM32F4xx family in the Nucleo-64 and Nucleo-144 series
  * Nucleo-F411RE
  * Nucleo-F446RE
  * Nucleo-F446ZE
