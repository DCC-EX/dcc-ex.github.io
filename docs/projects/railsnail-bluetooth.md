...
be controlled wirelessly from a suitable DCC App on a phone/tablet OR
Bluetooth enabled PC/Laptop/Mac.

In keeping with the \|DCC-EX\| current design philosophy, the
microcontroller board used in this design is the Arduino Mega2560 (or
clone) and a snap-on Arduino Motor Shield to provide the DCC signals to
the MAIN and PROG tracks.

The whole CommandStation is powered by one DC power supply (+15v DC)
...
[Railsnail\'s Bluetooth EX-CommandStation](https://railsnail.uk/)
