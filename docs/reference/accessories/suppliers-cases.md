...
David provides the files to make a 3D printed case or can sell an
...
Created by Neil McKechnie, one of the the DCC-EX Team developers, this
...
Created by Sumner Patterson, this is a range of Mega Command Station
cases with different configurations and different tops at different
heights to handle your boards:
...
[List of Sumner\'s 3D printed
cases](https://1fatgmc.com/RailRoad/3D-Printer/3D-Printer-Index.html)
\|EXTERNAL-LINK\|
...
Hans has created a stacking system of cases similar to the M5Stack
system. Using his skill in design and TinkerCAD, he is offering the
design files for free for you to 3D print yourself or have printed. He
also sells kits and accessories (like a Loconet board) in his Tindie
store:
...
[Hans Tanner\'s IoTT Tindie
store](https://www.tindie.com/stores/tanner87661/items/)
\|EXTERNAL-LINK\|

[YouTube Video describing the enclosure
system](https://youtu.be/aBYER7211gA?si=EP9Ycd82tPHOKs_i)
\|EXTERNAL-LINK\|
