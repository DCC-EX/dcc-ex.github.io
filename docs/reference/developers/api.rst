...
These are the ``<M>`` and ``<P>`` commands documented in the :ref:`reference/software/command-summary-consolidated:write direct dcc packet` section of the Command Reference.
