...
- - `DCC-EX EX-MotorShield8874 RevA</reference/hardware/motorboards/ex-motor-shield-8874>`
  ...
  - 5
  - 
- - `Arduino Motor Shield R3</reference/hardware/motorboards/arduino-motor-shield>`[^4]
  - Yes
  - Yes
  - Conductor
  - UNO / Mega
  ...
  - 1.3 - 1.5
  - 
- - `Deek-Robot Motor Shield</reference/hardware/motorboards/deek-robot-motor-shield>`[^6]
  - Yes
  - Yes
  - Conductor
  - UNO / Mega
...
[^3]: Requires modification of the board to stack the second board

[^4]: The *Arduino Motor Shield R38* and the *Deek-Robot Motor Shield*
    are interchangeably referred to in this documentation as the
    *standard motor driver*

[^5]: Can be stacked, but it is complicated. See
    `/reference/hardware/motorboards/arduino-motor-shield-stacked`

[^6]: The *Arduino Motor Shield R38* and the *Deek-Robot Motor Shield*
    are interchangeably referred to in this documentation as the
    *standard motor driver*

[^7]: Can be stacked, but it is complicated. See
    `/reference/hardware/motorboards/arduino-motor-shield-stacked`

[^8]: Requires modification of the board to support Current Sense
