...
Ethernet or a few other options due to memory limitations. But as a
Command Station connected to \|JMRI\| with a USB cable it works great.

Support for the Arduino Uno will soon be discontinued for future
releases of the \|EX-CS\| software. You will continue to be able to
