...
Support for the Arduino Uno will soon be discontinued for future releases of the |EX_CS| software. You will continue to be able to install older versions.
