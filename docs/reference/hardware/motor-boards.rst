...
If your board is not in the list of supported motor driver types, or if you need to make changes or have more information about how motor drivers are configured in |EX-CS|, see:
