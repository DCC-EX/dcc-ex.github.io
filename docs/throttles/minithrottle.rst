...
Note, this is a "project" type throttle and requires the user to construct it to their specifications
...
* Multiple WiFi networks allowing the throttle to be portable and used on multiple layouts. Alternatively a direct serial connection to DCC++ may be used, which bypasses WiFi connectivity.
