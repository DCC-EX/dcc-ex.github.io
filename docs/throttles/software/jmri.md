...
\|JMRI\| is quite a powerful suite of software applications, and can be
...
Follow these instructions outlined in the [JMRi help
page](https://www.jmri.org/help/en/html/hardware/dcc-ex/index.shtml)
\|EXTERNAL-LINK\| to get connected.

## Create a new throttle

Once you have your connection to \|JMRI\| configured, you can launch a
new throttle using either the DecoderPro or PanelPro applications.

### DecoderPro

In DecoderPro, select \"New Throttle\" from the \"Actions\" menu.

![DecoderPro New Throttle](../../_static/images/jmri/decoderpro-new-throttle.png)

### PanelPro

In PanelPro, from the \"Tools\" menu, select \"Throttles\" -\> \"New
Throttle\".

![PanelPro New Throttle](../../_static/images/jmri/panelpro-new-throttle.png)

## Select and control a loco

At this point, you should have your \|JMRi\| throttle window open ready
for action:

![JMRI Throttle](../../_static/images/jmri/jmri-throttle.png)
...
Here we show a loco at address 3 selected, with track power turned on,
and running in a forward direction at 25% speed:

![JMRI Throttle Loco 3](../../_static/images/jmri/jmri-loco3.png)
...
If you\'re keen to learn more about \|JMRi\|, then we highly recommend
going to the [JMRI website](https://www.jmri.org/) \|EXTERNAL-LINK\| and
reading further on the features and possibilities available.
