...
a seasoned engineer or just starting your journey in model railroading,
\|ThrottleCard\| delivers powerful features wrapped in a beautiful,
easy-to-use interface. You can connect ThrottleCard to \|JMRI\| and
...
[ThrottleCard](https://apps.apple.com/app/apple-store/id6739982126?pt=451685&ct=dcc_ex&mt=8)
\|EXTERNAL-LINK\|
...
- Control multiple trains simultaneously with intuitive multi-throttle
  support
- Beautiful vintage-inspired gauges and controls with realistic
  animations
- Game Controller Support! Easily drive your Trains with a PlayStation,
  Xbox, or Nintendo Switch Controller with pre-mapped buttons
...
- \|ThrottleCard\| will search for the \|WiThrottle Server\| on the
  \|EX-CS\| and show in the connections list
- If your \|WiThrottle Server\| is not showing in the list, you can
  manually add it by entering the IP address of the \|EX-CS\| and the
  port number - usually 12090 or 2560

To use ThrottleCard, simply connect to any WiThrottle Protocol enabled
command station including JMRI, DCC-EX, and various commercial
offerings. ThrottleCard can be used for free without a subscription to
control the speed, direction, and functions of a single locomotive at a
time, throw turnouts, and change the theme.

Subscribe to Premium for US\$0.99/Month or US\$9.99/Year - 16% off - to
unlock multiple throttles, multiple locomotives in a consist, game
controllers, and to support the future development of additional,
exciting features! We\'ll even give you a week free to try it out.
