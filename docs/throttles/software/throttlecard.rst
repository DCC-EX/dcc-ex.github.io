...
* Game Controller Support! Easily drive your Trains with a PlayStation, Xbox, Nintendo Switch, or MFi Game Controller with pre-mapped buttons
* Landscape mode on iPhone is optimized for excellent compatibility with handheld MFi Game Controllers. 
...
* Routes Support
* Fast Clock Support
* Supports WiThrottle and DCC-EX Protocols
* Roster with locomotive images
* A variety of classic railroad inspired themes
...
With many more exciting features like CV programming in the roadmap!
...
* |ThrottleCard| will search for the DCC-EX or |WiThrottle Server| on the |EX-CS| and show in the connections list
...
To use ThrottleCard, simply connect to any WiThrottle or DCC-EX Protocol enabled command station including JMRI, DCC-EX, and various commercial offerings. 
